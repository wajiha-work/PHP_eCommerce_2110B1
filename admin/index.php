...
$headList = [
  ...
  '<link rel="stylesheet" href="../Templates/Admin/vendors/niceselect/css/nice-select.css" />',

  '<link rel="stylesheet" href="../Templates/Admin/vendors/owl_carousel/css/owl.carousel.css" />',

  '<link rel="stylesheet" href="../Templates/Admin/vendors/gijgo/gijgo.min.css" />',

  '<link rel="stylesheet" href="../Templates/Admin/vendors/font_awesome/css/all.min.css" />',
  '<link rel="stylesheet" href="../Templates/Admin/vendors/tagsinput/tagsinput.css" />',

  '<link rel="stylesheet" href="../Templates/Admin/vendors/datepicker/date-picker.css" />',
  '<link rel="stylesheet" href="../Templates/Admin/vendors/vectormap-home/vectormap-2.0.2.css" />',
  ...
  '<link rel="stylesheet" href="../Templates/Admin/vendors/morris/morris.css">',

  '<link rel="stylesheet" href="../Templates/Admin/vendors/material_icon/material-icons.css" />',
        ...
        <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
          ...
          <div class="page_title_right">
            <div class="page_date_button d-flex align-items-center">
              <img src="../Templates/Admin/img/icon/calender_icon.svg" alt="">
            ...
            <div class="col-lg-6">
              <div class="single_crm">
                <div class="crm_head d-flex align-items-center justify-content-between">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/crm/businessman.svg" alt="">
                  </div>
            ...
            <div class="col-lg-6">
              <div class="single_crm ">
                <div class="crm_head crm_bg_1 d-flex align-items-center justify-content-between">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/crm/customer.svg" alt="">
                  </div>
                  <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                </div>
                <div class="crm_body">
            ...
            <div class="col-lg-6">
              <div class="single_crm">
                <div class="crm_head crm_bg_2 d-flex align-items-center justify-content-between">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/crm/infographic.svg" alt="">
                  </div>
                  <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                </div>
                <div class="crm_body">
            ...
            <div class="col-lg-6">
              <div class="single_crm">
                <div class="crm_head crm_bg_3 d-flex align-items-center justify-content-between">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/crm/sqr.svg" alt="">
                  </div>
                  <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                </div>
                <div class="crm_body">
          ...
          <div class="white_card_body ">
            <div class="single_user_pil d-flex align-items-center justify-content-between">
              <div class="user_pils_thumb d-flex align-items-center">
                <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/1.png" alt=""></div>
            ...
            <div class="monthly_plan_wraper">
              <div class="single_plan d-flex align-items-center justify-content-between">
                <div class="plan_left d-flex align-items-center">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/icon2/7.svg" alt="">
                  </div>
                  <div>
                    <h5>Most Sales</h5>
              ...
              <div class="single_plan d-flex align-items-center justify-content-between">
                <div class="plan_left d-flex align-items-center">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/icon2/6.svg" alt="">
                  </div>
                  <div>
              ...
              <div class="single_plan d-flex align-items-center justify-content-between">
                <div class="plan_left d-flex align-items-center">
                  <div class="thumb">
                    <img src="../Templates/Admin/img/icon2/5.svg" alt="">
                  </div>
                  <div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="single_plan d-flex align-items-center justify-content-between">
                    <div class="plan_left d-flex align-items-center">
                      <div class="thumb">
                        <img src="../Templates/Admin/img/icon2/3.svg" alt="">
                      </div>
                      <div>
                        <h5>$2,034</h5>
                ...
                <div class="col-lg-6">
                  <div class="single_plan d-flex align-items-center justify-content-between">
                    <div class="plan_left d-flex align-items-center">
                      <div class="thumb">
                        <img src="../Templates/Admin/img/icon2/1.svg" alt="">
                      </div>
                      <div>
                        <h5>$706</h5>
                        <span>Commision</span>
                ...
                <div class="col-lg-6">
                  <div class="single_plan d-flex align-items-center justify-content-between">
                    <div class="plan_left d-flex align-items-center">
                      <div class="thumb">
                        <img src="../Templates/Admin/img/icon2/4.svg" alt="">
                      </div>
                      <div>
                        <h5>$49</h5>
                ...
                <div class="col-lg-6">
                  <div class="single_plan d-flex align-items-center justify-content-between">
                    <div class="plan_left d-flex align-items-center">
                      <div class="thumb">
                        <img src="../Templates/Admin/img/icon2/2.svg" alt="">
                      </div>
                      <div>
                        <h5>$5.8M</h5>
              ...
              <table class="table lms_table_active2 p-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_1.png" alt=""></div>
                  ...
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_2.png" alt=""></div>
                  ...
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_3.png" alt=""></div>
                  ...
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_4.png" alt=""></div>
                  ...
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_5.png" alt=""></div>
                  ...
                  <tr>
                    <td>
                      <div class="customer d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../Templates/Admin/img/customers/pro_6.png" alt=""></div>
        ...
        <div class="white_card card_height_100 mb_30">
          ...
          <div class="white_card_body">
            <div class="thumb mb_30">
              <img src="../Templates/Admin/img/table.svg" alt="" class="img-fluid">
            </div>
...
$scriptList = [
  ...
  '<script src="../Templates/Admin/vendors/count_up/jquery.waypoints.min.js"></script>',

  '<script src="../Templates/Admin/vendors/chartlist/Chart.min.js"></script>',

  '<script src="../Templates/Admin/vendors/count_up/jquery.counterup.min.js"></script>',

  '<script src="../Templates/Admin/vendors/niceselect/js/jquery.nice-select.min.js"></script>',

  '<script src="../Templates/Admin/vendors/owl_carousel/js/owl.carousel.min.js"></script>',
  ...
  '<script src="../Templates/Admin/vendors/datepicker/datepicker.js"></script>',
  '<script src="../Templates/Admin/vendors/datepicker/datepicker.en.js"></script>',
  '<script src="../Templates/Admin/vendors/datepicker/datepicker.custom.js"></script>',
  '<script src="../Templates/Admin/js/chart.min.js"></script>',
  '<script src="../Templates/Admin/vendors/chartjs/roundedBar.min.js"></script>',

  '<script src="../Templates/Admin/vendors/progressbar/jquery.barfiller.js"></script>',

  '<script src="../Templates/Admin/vendors/tagsinput/tagsinput.js"></script>',

  '<script src="../Templates/Admin/vendors/text_editor/summernote-bs4.js"></script>',
  '<script src="../Templates/Admin/vendors/am_chart/amcharts.js"></script>',
  ...
  '<script src="../Templates/Admin/vendors/vectormap-home/vectormap-2.0.2.min.js"></script>',
  '<script src="../Templates/Admin/vendors/vectormap-home/vectormap-world-mill-en.js"></script>',

  '<script src="../Templates/Admin/vendors/apex_chart/apex-chart2.js"></script>',
  '<script src="../Templates/Admin/vendors/apex_chart/apex_dashboard.js"></script>',

  '<script src="../Templates/Admin/vendors/chart_am/core.js"></script>',
  '<script src="../Templates/Admin/vendors/chart_am/charts.js"></script>',
  '<script src="../Templates/Admin/vendors/chart_am/animated.js"></script>',
  '<script src="../Templates/Admin/vendors/chart_am/kelly.js"></script>',
  '<script src="../Templates/Admin/vendors/chart_am/chart-custom.js"></script>',

  '<script src="../Templates/Admin/js/dashboard_init.js"></script>',
  '<script src="../Templates/Admin/js/custom.js"></script>',
  '<script src="../module_js_scripts/Admin/index_admin.js"></script>',
];
