                    ...
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="../Templates/Admin/img/staf/1.png" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="../Templates/Admin/img/staf/2.png" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="../Templates/Admin/img/staf/3.png" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="../Templates/Admin/img/staf/4.png" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="../Templates/Admin/img/staf/5.png" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
    ...
    <!-- list of scripts src tags -->
    <?php
    if (isset($scriptList) && !empty($scriptList)) {
    ...
    <script>
        <?php
        if (isset($footScript) && !empty($footScript)) {
            echo $footScript;
        }
        ?>
    </script>

    <script src="../module_js_scripts/admin/main_layout_script.js"></script>
